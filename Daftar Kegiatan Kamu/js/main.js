  ...
  if (list.length === 0) {
    ...
    const element = String.raw`
			<div class="ui icon warning message">
				...
				<div class="content">
					<div class="header">Kamu Tidak Mempunyai Kegiatan Hari Ini!</div>
					<div>Tulis Kegiatan Mu Diatas.</div>
				</div>
			</div>
		`
...
function addTask(event) {
  ...
  showNotification("success", "Kegiatan Berhasil Diupload")
  showTasksList()
}
...
function removeTask(id) {
  ...
  showNotification("error", "Kegiatan Berhasil Dihapus")
  showTasksList()
}
